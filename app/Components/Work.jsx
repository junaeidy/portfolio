...
const Work = (isDarkMode) => {
  return (
    ...
    className='w-full px-[12%] py-10 scroll-mt-20' id='work'>
        ...
        className='text-center font-Ovo mb-2 text-lg'>My Portfolio</motion.h4>
        ...
        className='grid grid-cols-auto gap-5 my-10 dark:text-black'>
            {workData.map((project, index)=>(
                ...
                key={index} className='aspect-square bg-no-repeat bg-cover rounded-lg relative cursor-pointer group' style={{backgroundImage: `url(${project.bgImage})`}}>
